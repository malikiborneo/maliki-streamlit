...
projects = [
    {
        ...
        'description': [
            "The problem we are addressing is the current attrition rate of 15% at XYZ Ltd., a large company with 4,000 employees.",
            "This high turnover rate is creating operational disruptions and elevating hiring costs, thus impacting business productivity and profits.",
    ...
    },
    {
        ...
        'description': [
            "Luxura&apos;s key issue is to identify which luxury brand, be it Adibi, Balena, or Celinna, should receive prioritization in marketing efforts.",
            "Customer preferences, partnership fees, and each brand&apos;s contribution to growth all play pivotal roles in this decision-making process."
        ],
    ...
    },
    {
        ...
        'description': [
            "Using SQL BigQuery, I analyzed TheLook&apos;s data to tackle upcoming 2023 challenges.",
            "We identified underperforming product categories from the past year and studied customer retention trends from 2022.",
            "The goal was to improve resource allocation and boost profitability."
        ],
    ...
    },
    {
        ...
        'description': [
            "Using Google Colab and Python, I analyzed RevoBank&apos;s transaction data to assess the performance of their promotion program.",
            "I determined the sales impact, cost, and revenue generated by the promotion.",
            "Further, I segmented RevoShop&apos;s credit card users into distinct categories based on various attributes. This segmentation helped pinpoint opportunities to personalize the rewards program for different customer groups, utilizing clustering, EDA, and propensity model evaluations."
        ],
    ...
    },
    {
        ...
        'description': [
            "I developed a Tableau dashboard for Samba Commerce, a prominent e-commerce platform in Brazil.",
            "This dashboard effectively tracks sales metrics, highlights popular products, and offers insights to optimize inventory decisions.",
            "Through the dashboard, I analyzed customer behaviors, including their buying frequency and preferred payment methods, aiming to enhance Samba&apos;s marketing strategies.",
            "Additionally, I examined order delivery patterns to pinpoint and rectify any inefficiencies, while also providing a comprehensive view of payment trends to inform the company&apos;s financial strategies."
        ],
    ...
    },
    {
        ...
        'description': [
            "Pizzain Yuk has recently faced a revenue decline, with a -3.03% decrease over recent months.",
            "Although there was a slight upturn in the 2nd quarter with a 1.4% increase, the revenue decreased by -1.6% in the 3rd quarter and further declined by -2.8% in the 4th quarter.",
            "Several factors, such as product offerings, pricing, and sale timings, might be influencing this drop. Based on the analysis, we&apos;ve devised strategies to boost revenue:",
            "Launch targeted advertisements or promotions, especially during peak hours of 16-19 PM.",
            "Implement regular sales evaluations, whether quarterly, monthly, or weekly, for quicker adjustments.",
            "Adjust operational hours, possibly from 10 PM to midnight, to cater to late-night customers.",
            "Offer discounts or bundled packages on weekends, capitalizing on Friday&apos;s peak order rate.",
            "Introduce size variations for the 'brie carre' pizza and promotional offers for the 'Greek Pizza XXL'.",
            "With these strategies, the objective is to achieve a 20% revenue increase within the next year."
        ],
