...
projects = [
    ...
    },
    {
        ...
        'description': 'I developed a Tableau dashboard for Samba Commerce, a prominent e-commerce platform in Brazil. This dashboard effectively tracks sales metrics, highlights popular products, and offers insights to optimize inventory decisions.<br>Through the dashboard, I analyzed customer behaviors, including their buying frequency and preferred payment methods, aiming to enhance Samba&apos;s marketing strategies.<br> Additionally, I examined order delivery patterns to pinpoint and rectify any inefficiencies, while also providing a comprehensive view of payment trends to inform the company&apos;s financial strategies.',
